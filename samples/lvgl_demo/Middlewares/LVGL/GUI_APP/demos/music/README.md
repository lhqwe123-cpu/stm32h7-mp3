...
- The spectrum meter UI does the followings:
	...
	- Display the 4 bands on the left side of a circle by default at 0бу, 45бу, 90бу, 135бу 
	- Add extra bars next to the "main bars" with a cosine shape. Add more bars for the lower bands.
	- If the there is a large enough bass add a random offset to the position of the bars. E.g. start from 63бу istead of 0бу. (bars greater than 180бу start again from 0бу)
