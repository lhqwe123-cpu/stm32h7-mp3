...
static void build_firmware_upgrade_screen(void)
{
    ...
    {
        lv_obj_t *bg = lv_image_create(g_fw_upg_scr);
    ...
    /* SD 卡升级按钮 */
    lv_obj_t *sd_btn = lv_button_create(g_fw_upg_scr);
    ...
    /* 串口升级按钮 */
    lv_obj_t *uart_btn = lv_button_create(g_fw_upg_scr);
    ...
    /* Firmware Info 按钮 */
    lv_obj_t *info_btn = lv_button_create(g_fw_upg_scr);
    ...
    /* Confirm FW 按钮 */
    lv_obj_t *confirm_btn = lv_button_create(g_fw_upg_scr);
    ...
    /* 返回按钮 */
    lv_obj_t *back_btn = lv_button_create(g_fw_upg_scr);
